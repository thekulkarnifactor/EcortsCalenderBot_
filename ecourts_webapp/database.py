...
class CaseDatabase:
    ...
    #     list_of_json_strings = json.loads(raw_content)
    #     data_list = [json.loads(item) for item in list_of_json_strings]
    ...
    def _row_to_dict(self, row: tuple) -> Dict:
        ...
        columns = [
            ...
            'disp_name', 'updated_at', 'user_notes', 'is_changed', 'change_summary', 'raw_data'
        ]
